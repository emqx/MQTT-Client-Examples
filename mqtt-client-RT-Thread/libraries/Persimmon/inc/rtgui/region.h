...
void rtgui_region_auto_reset(rtgui_region_t *region, const rtgui_rect_t *rect);
...
rt_bool_t rtgui_region_is_empty(rtgui_region_t *region);
...
rtgui_point_t rtgui_rect_clip_to_align(const rtgui_rect_t *rect, rtgui_rect_t *to, int align);
void rtgui_rect_inflate(rtgui_rect_t *rect, int d);
void rtgui_rect_intersect(const rtgui_rect_t *src, rtgui_rect_t *dest);
rt_bool_t rtgui_rect_contains_point(const rtgui_rect_t *rect, int x, int y);
rt_bool_t rtgui_rect_contains_rect(const rtgui_rect_t *rect1, const rtgui_rect_t *rect2);
...
void rtgui_rect_clear(rtgui_rect_t *rect);
