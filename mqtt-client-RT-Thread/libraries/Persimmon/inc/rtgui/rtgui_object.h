...
rtgui_object_t* rtgui_object_create_ex(
    const rtgui_type_t *object_type, void* (*alloc)(rt_size_t));
void rtgui_object_destroy_ex(
    rtgui_object_t *object, void (*free)(void*));
