...
struct rtgui_image_engine
{
    ...
    void (*image_blit)(struct rtgui_image *image, struct rtgui_point *point, struct rtgui_dc *dc, struct rtgui_rect *rect);
};
...
void rtgui_system_image_deinit(void);
...
/* blit an image on DC */
void rtgui_image_blit(struct rtgui_image *image, struct rtgui_point *point, struct rtgui_dc *dc, struct rtgui_rect *rect);
