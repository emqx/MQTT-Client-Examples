...
void rtgui_container_move_child_top(rtgui_container_t *container, rtgui_widget_t *child);
void rtgui_container_move_child_bottom(rtgui_container_t *container, rtgui_widget_t *child);
void rtgui_container_move_child_up(rtgui_container_t *container, rtgui_widget_t *child);
void rtgui_container_move_child_down(rtgui_container_t *container, rtgui_widget_t *child);
void rtgui_container_move_child_above(rtgui_container_t *container, rtgui_widget_t *child, rtgui_widget_t *ref);
void rtgui_container_move_child_below(rtgui_container_t *container, rtgui_widget_t *child, rtgui_widget_t *ref);
