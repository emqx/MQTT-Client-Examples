...
{
    rt_uint8_t *src;
    int src_tex_width, src_tex_height;      /* src 源数据像素点宽度, src 源数据像素点高度 */
    int src_x, src_y;                       /* src 源数据需要显示的坐标(src_x, src_y) */
    int src_w, src_h;                       /* src 源数据需要显示的宽度和高度 */
    int src_pitch;
    int src_skip;

    rt_uint8_t *dst;
    int dst_tex_width, dst_tex_height;      /* dst 目标数据像素点宽度, dst 目标数据像素点高度 */
    int dst_x, dst_y;                       /* dst 目标数据需要显示的坐标(dst_x, dst_y) */
    int dst_w, dst_h;                       /* dst 目标数据需要显示的宽度和高度 */
    int dst_pitch;
    int dst_skip;
